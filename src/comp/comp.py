...
range_letters = ['C', 'D', 'E', 'F', 'G']
c = [human.name for human in humans if (human.name[0] in range_letters)]
print(c, 'humans with names C ==> G')
...
g = [human.name.upper() and human.age + 5 for human in humans]
print(g, 'NAME age + 5')
